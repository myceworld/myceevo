...
{
    switch (unit) {
    case Unit::BTC: return QString("MYCE");
    case Unit::mBTC: return QString("mMYCE");
    case Unit::uBTC: return QString::fromUtf8("µMYCE (mits)");
...
{
    switch (unit) {
    case Unit::BTC: return QString("Myces");
    case Unit::mBTC: return QString("Milli-Myces (1 / 1" THIN_SP_UTF8 "000)");
    case Unit::uBTC: return QString("Micro-Myces (bits) (1 / 1" THIN_SP_UTF8 "000" THIN_SP_UTF8 "000)");
