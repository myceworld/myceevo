...
void MasternodeList::StartAlias(CConnman& connman, std::string strAlias)
{
...
void MasternodeList::StartAll(CConnman& connman, std::string strCommand)
{
    ...
    for (CMasternode& mn : vMasternodes) {
        if (strCurrentFilter != "") {
            strToFilter = QString::fromStdString(mn.addr.ToString()) + " " +
                          ...
                          QString::fromStdString(EncodeDestination(PKHash(mn.pubKeyCollateralAddress)));
...
void MasternodeList::on_startButton_clicked(CConnman& connman)
{
    ...
    StartAlias(connman, strAlias);
}

void MasternodeList::on_startAllButton_clicked(CConnman& connman)
{
    // Display message box
...
void MasternodeList::on_startMissingButton_clicked(CConnman& connman)
{
    ...
    StartAll(connman, "start-missing");
}
